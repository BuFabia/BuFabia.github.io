window.onload = function () {
		...
		L.marker([46.49926, 11.35661], { title: "Ziel Etappe 1", icon: end}).addTo(map);
		var start = L.icon({
			iconUrl: 'icons/cabin-2.png',
			iconAnchor: [16, 37]
		});
		...
		L.marker([46.465, 10.373056], { title: "Ziel Etappe 2", icon: end}).addTo(map);
		var start = L.icon({
			iconUrl: 'icons/cabin-2.png',
			iconAnchor: [16, 37]
		});
		...
		L.marker([46.366667, 11.033333], { title: "Ziel Etappe 3", icon: end}).addTo(map);
		var start = L.icon({
			iconUrl: 'icons/cabin-2.png',
			iconAnchor: [16, 37]
		});
